...
<body>
    ...
    ?>
        ...
        <!-- <h2>Filtres</h2> -->
            ...
            echo '<form action="./traitement.php" method="get" name="monForm">';
            echo '<select id="genre" name="genre" size="1" class="liste">';
            echo $myForm[0]->echoForm();
            /* echo $myForm[1]->echoForm();
            echo $myForm[2]->echoForm(); */
            echo '</select>';
            ...
            ?>
                    ...
                    $formulaire = new formulaire($nomGenre);
                    echo $formulaire->nomGenre();
